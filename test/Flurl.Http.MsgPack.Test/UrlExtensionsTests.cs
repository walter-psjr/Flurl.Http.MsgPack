...
namespace Flurl.Http.MsgPack.Test
{
    public class UrlExtensionsTests
    {
        ...
        public async Task GetMsgPackAsync_TypelessContract()
        {
            ...
            // Act
            var result = await new Url("https://api.test.com").GetMsgPackAsync<TypelessModel>();
        ...
        public async Task PostMsgPackAsync_TypelessContract()
        {
            ...
            // Act
            var result = await new Url("https://api.test.com").PostMsgPackAsync(typelessModel);
        ...
        public async Task PutMsgPackAsync_TypelessContract()
        {
            ...
            // Act
            var result = await new Url("https://api.test.com").PutMsgPackAsync(typelessModel);
        ...
        public async Task SendMsgPackAsync_TypelessContract()
        {
            ...
            // Act
            var result = await new Url("https://api.test.com").SendMsgPackAsync(HttpMethod.Get, null).ReceiveMsgPack<TypelessModel>();
